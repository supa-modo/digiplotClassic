          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center space-x-4">
              <div className="p-3 md:p-4 bg-gradient-to-br from-secondary-600/20 to-secondary-plot/20 rounded-xl backdrop-blur-sm border border-white/20">
                <TbUser className="h-7 md:h-8 w-7 md:w-8 text-secondary-600" />
              </div>
              <div>
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      flex items-center space-x-3 px-4 lg:px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-300 whitespace-nowrap
                      ${
                        activeTab === tab.id
