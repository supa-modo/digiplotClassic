        ...
        <div className=" relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              ...
              <button className="mt-4 lg:mt-0 bg-gradient-to-r from-secondary-600/90 to-secondary-700 text-white text-[0.8rem] md:text-[0.98rem] px-6 py-3 md:py-2.5 rounded-lg hover:shadow-lg transition-colors duration-200 font-medium space-x-2  shadow-md">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6 space-y-2">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button className="inline-flex items-center px-3 py-2.5 border border-gray-200 text-gray-700 bg-white hover:bg-gray-50 font-medium rounded-xl transition-all duration-300 hover:shadow-md">
